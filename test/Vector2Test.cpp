...
TEST(Vector2Test, Angle)
{
    Vector2 a(1.0f, 0.0f);
    Vector2 b(0.0f, -1.0f);
    EXPECT_NEAR(Vector2::Angle(a, b), 90.0f, kToleranceEpsilon<float>);
}

TEST(Vector2Test, AngleEdgeCases)
{
    Vector2 v(1.0f, 0.0f);
    EXPECT_NEAR(Vector2::Angle(v, v), 0.0f, kToleranceEpsilon<float>);
    EXPECT_NEAR(Vector2::Angle(v, -v), 180.0f, kToleranceEpsilon<float>);
}
...
TEST(Vector2Test, SignedAngle)
{
    Vector2 a(1.0f, 0.0f);
    Vector2 b(0.0f, 1.0f);
    EXPECT_NEAR(Vector2::SignedAngle(a, b), 90.0f, kToleranceEpsilon<float>);
    EXPECT_NEAR(Vector2::SignedAngle(b, a), -90.0f, kToleranceEpsilon<float>);
}
