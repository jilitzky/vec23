...
TEST(Vector2Test, Angle)
{
    Vector2 a(1.f, 0.f);
    Vector2 b(0.f, -1.f);
    EXPECT_NEAR(Vector2::Angle(a, b), 90.f, Vector2::kToleranceEpsilon);
}

TEST(Vector2Test, AngleEdgeCases)
{
    Vector2 v(1.f, 0.f);
    EXPECT_NEAR(Vector2::Angle(v, v), 0.f, Vector2::kToleranceEpsilon);
    EXPECT_NEAR(Vector2::Angle(v, -v), 180.f, Vector2::kToleranceEpsilon);
}
...
TEST(Vector2Test, SignedAngle)
{
    Vector2 a(1.f, 0.f);
    Vector2 b(0.f, 1.f);
    EXPECT_NEAR(Vector2::SignedAngle(a, b), 90.f, Vector2::kToleranceEpsilon);
    EXPECT_NEAR(Vector2::SignedAngle(b, a), -90.f, Vector2::kToleranceEpsilon);
}
